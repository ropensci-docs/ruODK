...
If the server holds a copy of the expected file, append its filename to
the version attachments URL to download only that file.

## See also

<https://docs.getodk.org/central-api-submission-management/#downloading-a-version-s-attachment>
