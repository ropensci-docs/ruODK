...
A list with the GeoJSON `FeatureCollection` holding the Entity's
geometry.

## Details

Returns the GeoJSON representation of an Entity's geometry attribute, if
available.

## See also

<https://docs.getodk.org/central-api-entity-management/#entity-geojson-representation>
