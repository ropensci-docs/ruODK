...
upon all system objects. No request body data is required. This endpoint
requires ODK Central v0.5 or later.

## See also

<https://docs.getodk.org/central-api-accounts-and-users/#assigning-an-actor-to-a-server-wide-role>
