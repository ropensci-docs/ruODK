...
`actor_id`/`role_id` pairs. It does not list Project-specific
Assignments; those need
[`project_assignment_list()`](https://docs.ropensci.org/ruODK/reference/project_assignment_list.md).

## See also

<https://docs.getodk.org/central-api-accounts-and-users/#listing-all-assignments>
