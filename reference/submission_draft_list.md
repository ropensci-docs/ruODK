...
A tibble with one row per Draft Submission and all Submission metadata
as columns as per the ODK Central API docs.

## Details

This lists every Submission made to the Draft Form, every time. Draft
Submissions test a Draft Form definition before publication.

## See also

<https://docs.getodk.org/central-api-submission-management/#listing-all-submissions-on-a-draft-form>
