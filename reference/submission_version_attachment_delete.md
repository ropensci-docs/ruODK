...
- filename:
  ...
  (character) The name of the file to clear, as given by
...
A DELETE to a version attachment's endpoint clears the uploaded bytes of
that version while the expected file slot remains listed.

## See also

<https://docs.getodk.org/central-api-submission-management/#clearing-a-submission-version-s-attachment>
