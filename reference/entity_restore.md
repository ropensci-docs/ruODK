...
Entities that have been recently soft-deleted and not yet purged can be
restored with this endpoint.

## See also

<https://docs.getodk.org/central-api-entity-management/#restoring-a-deleted-entity>
