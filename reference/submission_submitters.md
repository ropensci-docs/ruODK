...
A tibble with one row per submitting Actor and all Actor metadata as
...
given Form. Each Actor that has submitted to the given Form is returned
once.

## See also

<https://docs.getodk.org/central-api-submission-management/#listing-submitters>
