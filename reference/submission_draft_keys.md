...
A tibble with one row per encryption key and all key metadata as columns
as per the ODK Central API docs.

## Details

This lists the managed and self-supplied encryption keys of Submissions
made to a Draft Form.
