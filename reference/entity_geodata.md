...
`type` and `features` with `geometry` and `properties` per Entity.

## Details

This endpoint returns the geometry-interpretable value of the geometry
attribute of Entities of a Dataset, in GeoJSON format. No particular
ordering is implied.

## See also

<https://docs.getodk.org/central-api-entity-management/#entities-geodata>
