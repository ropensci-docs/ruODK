...
- eids:
  ...
  (character) The UUIDs of the deleted Entities to restore.
...
A list with a single element `count` holding the number of Entities that
the bulk operation deleted or restored.

## Details

This endpoint accepts an array of Entity UUIDs and restores all of them
that were previously deleted.

## See also

<https://docs.getodk.org/central-api-entity-management/#bulk-restoring-entities>
