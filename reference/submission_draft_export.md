...
- dest:
  ...
  (character) The local file path to save the ZIP export to. Default:
  `NULL`, which saves to a temporary `.zip` file.
...
The local file path the ZIP export was saved to.
