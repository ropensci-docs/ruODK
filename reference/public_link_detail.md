...
A tibble with one row holding the Link's metadata as columns as per the
ODK Central API docs.

## Details

Returns the details of a single Public Access Link by its numeric ID.

## See also

<https://docs.getodk.org/central-api-form-management/#getting-link-details>
