...
- version:
  ...
  (character) The published Form version whose schema fields to return,
  e.g. from
  [`form_version_list()`](https://docs.ropensci.org/ruODK/reference/form_version_list.md).
  Pass `___` for a blank version. If given, the version path is used
  instead of the published or draft path. Default: `NULL`.
...
<https://docs.getodk.org/central-api-form-management/#getting-form-version-schema-fields>
