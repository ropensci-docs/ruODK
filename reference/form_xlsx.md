...
function gets that file back. Forms created from XForms XML have no
spreadsheet source, and Central answers those requests with 404.

## See also

<https://docs.getodk.org/central-api-form-management/#retrieving-form-xls-x>
