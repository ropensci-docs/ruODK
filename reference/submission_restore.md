...
Restores a Submission deleted with
[`submission_delete()`](https://docs.ropensci.org/ruODK/reference/submission_delete.md)
within its 30-day grace period. After this time, all of its resources
and attachments are automatically purged and the Submission can no
longer be restored.

## See also

<https://docs.getodk.org/central-api-submission-management/#restoring-a-deleted-submission>
