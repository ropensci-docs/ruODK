...
To upload a binary to an expected file slot of a Draft Submission, POST
the binary to its endpoint. Supply a `content_type` if you have one.

## See also

<https://docs.getodk.org/central-api-submission-management/#draft-submissions>
