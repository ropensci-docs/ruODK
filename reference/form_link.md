...
- form_link_id:
  ...
  (character) The Form Link ID, e.g. the Enketo ID of a published Form.
...
A tibble with one row holding the Form's metadata as columns as per the
ODK Central API docs.

## Details

Returns Form metadata for the provided Form Link ID without needing the
Project ID or Form ID.

## See also

<https://docs.getodk.org/central-api-form-management/#getting-form-details-by-formlinkid>
