...
A list with a single element `success` (`TRUE`). Central answers a
successful delete with HTTP 200 and a bare body, which this function
reports as `success`.
...
<https://docs.getodk.org/central-api-accounts-and-users/#deleting-a-sitewide-preference>
