...
A nested list of Draft Submission data.

## Details

This returns the XML of one Submission made to a Draft Form as a nested
list. Repeating subgroups stay nested, since their presence and length
